...
const Inputs : NextPage = () => {
  return (
    <div className="w-full flex bg-gray-400 justify-center items-center flex-wrap
        ...
        <button type="submit" className="text-white bg-green-700 p-1 py-2 md:py-1 md:px-5 md:text-[1rem] text-2xl px-3 rounded-sm border-none outline-none transition-all duration-300 hover:-translate-y-1 w-5/12 md:w-fit">Create</button>
    </div>
  )
}
